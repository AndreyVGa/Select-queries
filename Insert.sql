...
connection.execute("INSERT INTO musicians VALUES ( 2,'Михаил Круг','Михаил');")
...
connection.execute("INSERT INTO musicians VALUES ( 6,'Тимати','Тимур Ильдарович Юнусов ');")
connection.execute("INSERT INTO musicians VALUES ( 7,'Егор Крид','Егор Николаевич Булаткин ');")
...
connection.execute("""INSERT INTO tracks VALUES ( 3,'А сечку ешьте сами','2.59',2);""")
